"""
Voice conversation engine â€” same RAG + confidence gate as chat,
...
VOICE_SYSTEM_SUFFIX = (
    ...
    "- Keep responses SHORT â€” 1 to 3 sentences max.\n"
...
async def process_voice_turn(
    ...
    if confidence in ("PARTIAL", "NO_MATCH"):
        system += "\n[Retrieval confidence LOW â€” do NOT invent details. Capture name and phone instead.]"
    ...
    # English phrasing ("my name is...") â€” translate_to_english preserves digits
